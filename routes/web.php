...
Route::get('deleteExpense/{id}', [ExpenseController::class, 'delview'])->name('expense.delete.view');
Route::get('deleteCategory/{id}', [CategoryController::class, 'delview'])->name('category.delete.view');
...
Route::post('delCategory/{id}', [CategoryController::class, 'delete'])->name('category.del');
// get all category's
...
//update expense
Route::post('delExpense/{id}', [ExpenseController::class, 'delete'])->name('expense.delete');
//get all expenses
