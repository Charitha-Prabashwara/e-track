  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron" style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; background-color: rgb(240, 247, 255);">
        ...
        <form class="form-horizontal" method="POST" action="{{route('expense.create')}}">
          @csrf
          <fieldset>
          ...
          <div class="form-group form-inline">
            ...
            <input id="textinput" name="title" type="text" placeholder="" class="form-control input-md  w-100" required="">
          ...
          <div class="form-group form-inline">
            ...
            <input id="textinput" name="amount" type="number" placeholder="" class="form-control input-md w-100" required="">
          ...
          <div class="form-group form-inline">
              ...
              <button id="submit" name="submit" class="btn btn-success mr-3">Create</button>
